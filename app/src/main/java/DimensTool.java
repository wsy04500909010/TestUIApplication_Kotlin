...
/**
 * Created by WangSiYe on 2019/8/6.
 */
...
//                    sw240.append(start).append(num * 0.63).append(end).append("\r\n");
//
//                    sw480.append(start).append(num * 1.26).append(end).append("\r\n");
//
//                    sw600.append(start).append(num * 1.57).append(end).append("\r\n");
//
//                    sw720.append(start).append(num * 1.89).append(end).append("\r\n");
//
//                    sw800.append(start).append(num * 2.1).append(end).append("\r\n");
//
//                    w820.append(start).append(num * 2.15).append(end).append("\r\n");
