...
public class DFRoundTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs){
        ...
        mColor = ta.getColor(R.styleable.DFRoundTextView_df_round_text_color,getResources().getColor(R.color.colorPrimary));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (stock > 0) {
            ...
            mRectDrawable.setColor(Color.WHITE);
        }else{
            mRectDrawable.setColor(mColor);
        }
        mRectDrawable.setBounds(getPaddingLeft()+innerPadding,getPaddingTop()+innerPadding,getWidth()-getPaddingLeft()-innerPadding,getHeight()-getPaddingTop()-innerPadding);
