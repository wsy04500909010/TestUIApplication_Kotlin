...
/**
 * Created by WangSiYe on 2019/8/7.
 */
public class DimensTool2 implements Runnable{
...
//                if (k >= 12 && k <=24 & k%2 == 0) {
    ...
    public static void main(String[] args) {
        ...
        DimensTool2 dimensTool2 =new DimensTool2();
        dimensTool2.setPath("./app/src/main/res/");
